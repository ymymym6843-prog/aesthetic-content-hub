...
export const Icon = ({d, size=24, className="", fill="none", stroke="currentColor", onClick}) => (
...
export const MessageCircle = ({size=24,className="",fill="none"}) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill={fill} stroke="currentColor" strokeWidth="2" className={className}>
...
export const Layout = ({size=24,className="",onClick}) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"
    className={className} onClick={onClick} style={{cursor:'pointer'}}>
...
export const Volume2 = ({size=24,className=""}) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" className={className}>
